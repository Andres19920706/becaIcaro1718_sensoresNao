...
def main(session):
    ...
    names = "Body"
    stiffnessLists = 0.0 #0.0 Motor apagado, 1.0 motores a maxima potencia
    timeLists = 1.0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="192.168.1.39",
                        help="Robot IP address. On robot or Local Naoqi: use '192.168.1.39'.")
